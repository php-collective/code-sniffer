...
class DocBlockParamNotNullableTestClass
{
     ...
     *
     * @param Node|string $parent Should be fixed to just Node
     ...
     *
     * @param string|int $name Should be fixed to just string
     */
     ...
     *
     * @param Node|string|null $parent Should be fixed to Node|null
     */
     ...
     *
     * @param array|string $items Should be fixed to just array
     */
     ...
     *
     * @param int|string $count Should be fixed to just int
     */
     ...
     *
     * @param Node|string|array $parent Should be fixed to just Node
     */
     ...
     *
     * @param bool|string $flag Should be fixed to just bool
     */
     ...
     *
     * @param string|int|bool $value Should be fixed to string|int
     */
